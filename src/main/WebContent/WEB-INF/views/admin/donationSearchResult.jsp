        ...
        <main>
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Kết quả tìm kiếm đợt quyên góp cho từ khoá: ${stringQuery}</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <c:forEach var="page" begin="1" end="${pageIndex - 1}">
                                    <a href="${pageContext.request.contextPath}/admin/searchDonation?keyword=${stringQuery}&display=${display}&page=${page}&status=${status}">${page}</a>
                                </c:forEach>
                                ${pageIndex}
