      ...
      <header class="site-navbar mt-3">
        <div class="container-fluid">
          <div class="row align-items-center justify-content-between">
            <div class="col site-logo col-6">
              <a href="/">Website Quyên Góp</a>
            </div>
            <div class="col text-right">
              <c:choose>
                <c:when test="${currentUser != null}">
                  <p class="welcome" style="color: #89ba16">
                    Welcome ${currentUser.fullName}!|<a href="public/logout">
                      Logout</a
                    >
                  </p>
                </c:when>
          ...
          <ul class="job-listings mb-5">
            <th>
              ...
              >
                ...
                >
                  <div
                    class="job-listing-position custom-width mb-3 mb-sm-0"
                  ...
                  >
                    ...
                    <span th:text="${category.organizationName}"></span><br />
